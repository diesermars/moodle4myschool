...
/**
 * Strings for component 'block_xp', language 'de', version '3.10'.
 *
 * @package     block_xp
 * @category    string
...
$string['addoninstallationerror'] = 'Mit dem Add-on (local_xp) wurde ein Problem festgestellt, denn es scheint nicht richtig installiert zu sein. Ein Administrator sollte die Installation abschließen.';
...
$string['enablecheatguard_help'] = 'Der Cheat Guard bietet einen einfachen unaufwendigen Mechanismus, um eine Überlastung des Systems zu vermeiden. Unnötige Aktionen werden verhindert, wie z.B. die endlose Aktualisierung derselben Seite oder eine ständige Wiederholung derselben Aktion.
...
$string['eventsrules'] = 'Event-Regeln';
...
$string['maxactionspertime_help'] = 'Die maximale Anzahl von Aktionen, die während des Zeitrahmens für XP gegeben werden. Jede nachfolgende Aktion wird ignoriert. Dies ist ausgeschaltet, wenn dieser Wert leer oder gleich Null ist.';
...
$string['promocheatguard'] = 'Dieser Cheat Guard ist nicht dafür ausgelegt, lange Zeiträume abzudecken. Bitte erwägen Sie ein Upgrade auf <em>Level up! Plus</em>, um größere Zeiträume und andere Funktionen freizuschalten. <a href="{$a->url}">Erfahren Sie hier mehr</a>.';
...
$string['promointroinstalled'] = 'Das Add-on _Level up! Plus_ ist auf Ihrem System installiert und alle seine Funktionen wurden aktiviert.';
...
$string['xp:viewlogs'] = 'Die Logs ansehen';
$string['xpgaindisabled'] = 'XP-Zuwachs deaktivieren';
$string['xprequired'] = 'XP notwendig';
$string['xptogo'] = 'bis zur nächsten Stufe';
$string['youreachedlevel'] = 'Sie haben folgende Stufe erreicht:';
$string['youreachedlevela'] = 'Sie haben Stufe {$a} erreicht!';
