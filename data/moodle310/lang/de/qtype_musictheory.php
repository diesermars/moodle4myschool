...
/**
 * Strings for component 'qtype_musictheory', language 'de', version '3.10'.
 *
...
$string['chordquality_write_questionastext_help'] = '<p>Gib eine kommagetrennte Liste von Noten OHNE Leerzeichen ein. Verwende dafür folgende Schreibweise: </p><p>[Großbuchstabe][Vorzeichen
  ("n" = ohne Vorzeichen, "#" = Kreuz, "b" = b-Vorzeichen, "x" = Doppelkreuz, "bb" = Doppel-b-Vorzeichen)]4, ... </p>
 <p>Zufallsbeispiel: <b>Antwort=>Cn4,En4,G#4</b></p>';
...
$string['harmonicfunction_write_questionastext_help'] = '<p>Gib eine kommagetrennte Liste von Noten OHNE Leerzeichen ein. Verwende dafür folgende Schreibweise: </p><p>[Großbuchstabe][Vorzeichen
  ("n" = ohne Vorzeichen, "#" = Kreuz, "b" = b-Vorzeichen, "x" = Doppelkreuz, "bb" = Doppel-b-Vorzeichen)]4, ... </p>
 <p>Zufallsbeispiel: <b>Antwort=>Cn4,En4,G#4</b></p>';
...
$string['hftype_secdom7th'] = 'Sekundärdominante (Septakkord)';
$string['hftype_secdomtriad'] = 'Sekundärdominante (Dreiklang)';
...
$string['interval_write_questionastext_help'] = '<p>Gib folgende Note OHNE Leerzeichen ein. Verwende dafür folgende Schreibweise: </p><p>[Großbuchstabe][Vorzeichen
...
$string['javascriptrequired'] = 'Dieser Text soll durch eine grafische Bedienoberfläche ersetzt werden. Dazu muss in deinem Browser Javascript zugelassen sein.';
...
$string['keysignature_write_questionastext_help'] = '<p>Gib eine kommagetrennte Liste von Vorzeichen (zwischen 1 und 7), OHNE Leerzeichen ein. Verwende dafür folgende Schreibweise: </p><p>[Großbuchstabe][Vorzeichen
...
$string['keysignature_write_questionasui_help'] = '<p>Für die Eingabe von Vorzeichenauf das Notensystem klicken, nachdem rechts in der Toolbar ein Vorzeichen ausgewählt wurde . Um ein Vorzeichen zu löschen einfach noch einmal auf das Vorzeichen klicken.</p>';
...
$string['musictheory_gradingstrategy_scale-write_help'] = '<p>Die Bewertungsstrategie definiert wie die Frage bewertet wird.</p>
 <p><b>Alles oder nichts</b>: Die Beantwortung wird mit der korrekten Antwort verglichen. Ist die Beantwortung richtig, erhält man die volle Punktezahl. Ist die Beantwortung falsch, erhält man 0 Punkte. </p><p><b>Teilpunkte für jede richtige Note</b>: Eine Bewertungsstrategie, bei der die Punktezahl gleichmäßig auf die Töne aufgeteilt wird, die die/der Lernende eingeben muss. Die/der Lernende erhält so für jede korrekte Note eine Teilpunktezahl.';
...
$string['note_write_questionastext_help'] = '<p>Gib folgende Note OHNE Leerzeichen ein. Verwende dafür folgende Schreibweise: </p><p>[Notenname, als Großbuchstabe][Versetzungszeichen
...
$string['privacy:metadata'] = 'Das Music Theory question type plugin speichert KEINE persönlichen Daten.';
...
$string['qtype_harmonicfunction-identify'] = 'Harmonischen Funktion benennen';
$string['qtype_harmonicfunction-identify-random'] = 'Harmonischen Funktion benennen (zufällig)';
...
$string['qtype_scale-write'] = 'Tonleiter notieren';
$string['qtype_scale-write-random'] = 'Tonleiter notieren (zufällig)';
...
$string['questiontext_chordquality_identify'] = 'Erkenne den Grundton und die Art des folgenden Akkords';
$string['questiontext_chordquality_write'] = 'Notiere den folgenden Akkord';
$string['questiontext_harmonicfunction_identify'] = 'Benenne die folgende harmonische Funktion';
$string['questiontext_harmonicfunction_write'] = 'Gib die folgende harmonische Funktion ein';
$string['questiontext_help'] = 'Dieses Feld ist nicht erforderlich. Wenn es leer gelassen wird, wird innerhalb der Aufgabe automatisch ein Fragetext angezeigt, der für den gegebenen Musikfragetyp geeignet ist. Wenn du Text in dieses Feld eingibst, ersetzt dieser den automatisch generierten Fragetext.';
$string['questiontext_interval_identify'] = 'Benenne das folgende Intervall';
$string['questiontext_interval_write_above'] = 'Gib das folgende Intervall <b>über</b> der gegebenen Note ein';
$string['questiontext_interval_write_below'] = 'Gib das folgende Intervall <b>unter</b> der gegebenen Note ein';
$string['questiontext_keyboard_input'] = 'Gib die folgende Note über die Klaviatur ein';
$string['questiontext_keysignature_identify_major'] = 'Bestimme die Dur-Tonart anhand der Vorzeichen';
$string['questiontext_keysignature_identify_minor'] = 'Bestimme die Moll-Tonart anhand der Vorzeichen';
$string['questiontext_keysignature_write'] = 'Gib die folgende Tonart ein';
$string['questiontext_note_identify'] = 'Benenne die folgende Note/den folgenden Ton';
$string['questiontext_note_write'] = 'Gib die folgende Note/den folgenden Ton ein';
$string['questiontext_scale_identify'] = 'Benenne die folgende Tonleiter';
$string['questiontext_scale_write'] = 'Schreibe die folgende Tonleiter in aufsteigender Richtung auf';
$string['questiontext_scale_write_melodic'] = 'Schreibe die folgende Tonleiter in aufsteigender und absteigender Richtung auf';
$string['rootposition'] = '[Grundton]';
$string['scale_write_questionastext'] = 'Eingabe: Tonleiter';
$string['scale_write_questionastext_help'] = '<p>Gib eine durch Komma getrennte Liste von Noten ein, einschließlich
 des angegebenen Grundtons, ohne Leerzeichen. Verwende folgende Syntax:</p><p>[Notenname, als Großbuchstabe]
 [Versetzungszeichen ("n" = natürlich, "#" = Kreuz, "b" = b-Vorzeichen, "x" = Doppelkreuz "bb" = Doppel-b-Vorzeichen)]
 Stimmlage (eine Ziffer zwischen 2 und 6, in Anlehnung an die musiktheoretische Notationsweise)], ... </p>
 <p>Beispiel: <b>Tonic = An4 answer=>An4,Bb4,C#5,D#5,E#5,F#5,G#5,An5</b></p>';
...
$string['validationerror_notewrite_twonotesingrandstaff'] = 'Es wurden 2 Noten/Töne eingegeben. Bitte nur eine Note/einen Ton eingeben.';
...
$string['validationerror_whitespace'] = 'Ungültige Syntax: entferne alle Leerzeichen.';
