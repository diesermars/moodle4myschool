...
/**
 * Strings for component 'qtype_stack', language 'de', version '3.10'.
 *
 * @package     qtype_stack
 * @category    string
...
$string['ATNumDecPlacesWrong_OptNotInt'] = 'Für die Antwortüberprüfung "NumDecPlacesWrong" muss die Test-Option eine positive ganze Zahl sein, aber es wurde "{$a->opt}" empfangen.';
...
$string['ATNumDecPlaces_OptNotInt'] = 'Für die Antwortüberprüfung "NumDecPlaces" muss die Test-Option eine positive ganze Zahl sein, aber es wurde "{$a->opt}" empfangen.';
$string['ATNumDecPlaces_Wrong_DPs'] = 'Ihre Antwort wurde mit der falschen Anzahl von Dezimalstellen gegeben.';
...
$string['healthchecksamplecas'] = 'Die Ableitung von {@ x^4/(1+x^4) @} ist \\[ \\frac{d}{dx} \\frac{x^4}{1+x^4} = {@ diff(x^4/(1+x^4),x) @}. \\] Bestätigen Sie, ob Unicode unterstützt wird: \\(\\forall\\) sollte als {@unicode(2200)@} angezeigt werden.';
...
$string['healthunabletolistavail'] = 'Der Plattformtyp ist derzeit nicht auf "unix" eingestellt und kann daher keine verfügbaren Versionen von Maxima auflisten.';
