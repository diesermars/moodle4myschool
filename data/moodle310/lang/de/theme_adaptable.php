...
/**
 * Strings for component 'theme_adaptable', language 'de', version '3.10'.
 *
...
$string['alertaccess'] = 'Hinweissichtbarkeit';
...
$string['alertcount'] = 'Hinweisanzahl';
...
$string['alertsettings'] = 'Hinweiskasten {$a}';
$string['alertsettingsgeneral'] = 'Allgemeine Hinweiseinstellungen';
$string['alertsettingsheading'] = 'Passen Sie das Hinweisfeld an, z.B. mit diesem <a href="./../theme/adaptable/pix/layout.png" target="_blank"> Layout </a>';
$string['alerttext'] = 'Hinweistext';
...
$string['blocklayoutlayoutcount1'] = 'Wählen Sie maximal';
...
$string['breadcrumb'] = 'Brotkrümel-Hintergrundfarbe';
...
$string['coursesettings'] = 'Kursabschnitte';
$string['coursesettingsheading'] = 'Kursabschnitte : Einstellungen';
$string['customcss'] = 'Änderungen für CSS';
$string['customcssjssettings'] = 'CSS und Javascript';
...
$string['enablesearchbox'] = 'Suchfeld aktivieren';
$string['enablesearchboxdesc'] = 'Suchfeld in der Kopfzeile anzeigen';
...
$string['frontpageblockregionsettings'] = 'Blockbereiche setzen';
...
$string['frontpagetickersettings'] = 'Startseite: Ticker';
$string['fullscreen'] = 'Volle Breite';
$string['fullscreenwidth'] = 'Volle Breite des Browserfensters';
$string['genericsettingsdescription'] = 'Hier sind Eingabefelder, um Anpassungen für CSS und Javascript zu Ihrem Design hinzuzufügen.';
...
$string['msgbadgecolor'] = 'Nachrichtensymbol Hintergrundfarbe.';
$string['msgbadgecolordesc'] = 'Wählen Sie die Hintergrundfarbe für das Nachrichtensymbol/ die Blase in der Kopfzeile (zeigt die Anzahl der ungelesenen Nachrichten an)';
...
$string['socialwallbackgroundcolor'] = 'Hintergrundfarbe';
$string['socialwallbordercolor'] = 'Rahmenfarbe';
...
$string['toolsmenulabel'] = 'Werkzeugmenü';
$string['toolsmenulabel2'] = 'Werkzeug 2';
