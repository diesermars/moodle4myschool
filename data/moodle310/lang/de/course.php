...
/**
 * Strings for component 'course', language 'de', version '3.10'.
 *
 * @package     course
 * @category    string
...
<p>Teilnehmer/innen im Kurs {$a->coursename} wurden als gefährdet, das Kursziel zu erreichen, eingestuft.</p>';
