...
/**
 * Strings for component 'tool_qeupgradehelper', language 'de', version '3.10'.
 *
...
$string['croninstructions'] = 'Sie können den Cron-Job damit beauftragen, die Aktualisierung automatisch nach und nach durchzuführen. Mit jeder Ausführung des Cron-Jobs wird ein weiterer Teilschritt der Testfragenversuchskonvertierung durchgeführt,  bis die festgelegte Zeitgrenze erreicht ist. Dieser Prozess hat Vorrang vor anderen Cron-job-Aufgaben bis die Aktualisierung für alle Testfragenversuche abgeschlossen ist.';
$string['cronprocesingtime'] = 'Prozesslaufzeit für jeden Cron-Job';
$string['cronsetup'] = 'Cron konfigurieren';
$string['cronsetup_desc'] = 'Sie können die Cron-Einstellungen automatisch anpassen, um die Aktualisierung der Testversuche abzuschließen.';
