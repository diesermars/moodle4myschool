...
/**
 * Strings for component 'moodle', language 'de', version '3.10'.
 *
 * @package     moodle
 * @category    string
...
$string['contentexport_footersummary'] = 'Diese Datei ist Teil des Inhalts, der am {$a->date} von {$a->userfullname}  von <a href="{$a->modulelink}">{$a->modulename}</a> heruntergeladen wurde. Beachten Sie, dass einige Inhalte und Dateien, die größer als {$a->maxfilesize} sind, nicht heruntergeladen werden.';
