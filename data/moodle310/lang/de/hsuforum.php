...
/**
 * Strings for component 'hsuforum', language 'de', version '3.10'.
 *
 * @package     hsuforum
 * @category    string
...
$string['configtrackingtype'] = 'Standardeinstellung für die Leseverfolgung';
...
$string['hideadvancededitor'] = 'Erweiterten Editor ausblenden';
...
$string['loadingeditor'] = 'Editor wird geladen...';
...
$string['messageisrequired'] = 'Eine Mittelung ist notwendig';
...
$string['subscribersto'] = 'Abonnent/innen von  "{$a->name}"';
...
$string['trackingtype'] = 'Lesenachverfolgung für dieses Forum?';
$string['trackingtype_help'] = 'Die Lesenachverfolgung erleichtert es den Teilnehmern durch optische Hervorhebung ungelesene Beiträge zu erkennen.
Wenn sie auf optional gesetzt wurde, können die Teilnehmer selbst wählen, ob sie die Lesenachverfolgung durch einen Klick im Administrationsblock ein- oder ausschalten wollen. (Die Nutzer müssen in ihren Foreneinstellungen die Forumnachverfolgung aktiviert haben).
Wenn \'Verpflichtende Lesenachverfolgung\' in der Siteadministration aktiviert wurde, ist eine weitere Option verfügbar - verpflichtend. Das bedeutet, dass die Lesenachverfolgung immer aktiviert ist, unabhängig von den Foreninstellungen der Nutzer.';
