...
/**
 * Strings for component 'mootyper', language 'de', version '3.10'.
 *
 * @package     mootyper
 * @category    string
...
$string['configtimelimit_desc'] = 'Wenn ein Zeitlimit festgelegt ist, wird zu Beginn der Lektion eine Warnung angezeigt und es gibt einen Countdown-Timer. Wenn Sie kein Zeitlimit festlegen möchten, setzen Sie diesen Wert auf Null.';
