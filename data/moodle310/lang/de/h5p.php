...
/**
 * Strings for component 'h5p', language 'de', version '3.10'.
 *
 * @package     h5p
 * @category    string
...
$string['task_h5p'] = 'Geplanter Vorgang für H5P';
$string['task_h5p_description'] = 'Der geplante Vorgang für H5P lädt verfügbare H5P-Inhaltstypen von H5P.org herunter.';
