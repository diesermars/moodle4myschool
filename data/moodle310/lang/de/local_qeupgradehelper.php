...
/**
 * Strings for component 'local_qeupgradehelper', language 'de', version '3.10'.
 *
...
$string['cronsetup_desc'] = 'Prozesslaufzeit für jeden Cron-Job';
...
$string['listupgradedintro'] = 'Übersicht über alle Tests, deren Testversuche upgedatet wurden und wo alte Testversuche zu finden sind, um sie zurückzusetzen und das Update erneut auszuführen.';
...
$string['veryoldattemtps'] = 'Ihre Seite enthält {$a} sehr alte Testversuche, die seit Moodle 1.4/1.5 nicht aktualisiert wurden. Diese Testversuche müssen zunächst \'in Ordnung\' gebracht werden bevor das Upgrade fortgesetzt wird. Planen Sie dafür zusätzliche Zeit ein.';
