...
/**
 * Strings for component 'local_checkmarkreport', language 'de', version '3.10'.
 *
...
$string['privacy:metadata:showattendances'] = 'Dauerhaft gespeicherte Einstellung, ob Anwesenheitsinfos angezeigt werden sollen oder nicht.';
$string['privacy:metadata:showexamples'] = 'Dauerhaft gespeicherte Einstellung, ob Beispiele angezeigt werden sollen oder nicht.';
$string['privacy:metadata:showgrade'] = 'Dauerhaft gespeicherte Einstellung, ob Noten angezeigt werden sollen oder nicht.';
$string['privacy:metadata:showpoints'] = 'Dauerhaft gespeicherte Einstellung, ob für gekreuzte Beispiele Icons/Symbole oder Punkte angezeigt werden sollen.';
$string['privacy:metadata:showpresentationcounts'] = 'Dauerhaft gespeicherte Einstellung, ob die Anzahl der bewerteten Präsentationen angezeigt werden soll oder nicht.';
$string['privacy:metadata:showpresentationgrades'] = 'Dauerhaft  gespeicherte Einstellung, ob Präsentationsnoten angezeigt werden sollen oder nicht.';
$string['privacy:metadata:signature'] = 'Dauerhaft gespeicherte Einstellung, ob ein Unterschriftsfeld eingefügt werden soll oder nicht.';
$string['privacy:metadata:sumabs'] = 'Dauerhaft gespeicherte Einstellung, ob absolute Werte angezeigt werden sollen oder nicht.';
$string['privacy:metadata:sumrel'] = 'Dauerhaft gespeicherte Einstellung, ob Prozentwerte angezeigt werden sollen oder nicht.';
