...
/**
 * Strings for component 'theme_fordson', language 'de', version '3.10'.
 *
...
$string['bodycolor'] = 'Standard-Textfarbe';
$string['bodycolor_desc'] = 'Standard-Textfarbe.';
...
$string['brandgray'] = 'Basisgrau';
$string['brandgray_desc'] = 'Diese Farbe wird für das Erzeugen der Grauschattierungen verwenden. Standardmässig ist es #000, dies kann aber angepasst werden';
...
$string['enablefrontpageavailablecoursebox'] = 'Erweiterte Kursdarstellung aktivieren';
$string['enablefrontpageavailablecoursebox_desc'] = 'Erweiterte Kurstdarstellung zeigt den Kurs als Kacheln in einem Grid und benutzt Symbole für Kurskategorien. Für die klassische Darstellung bitte diese Funktion deaktivieren.';
...
$string['footerbg'] = 'Hintergrundfarbe des Footers';
$string['footerbg_desc'] = 'Die Hintergrundfarbe des Footers.';
...
$string['fpicon-colour'] = 'Farbe des Homepage-Links';
$string['fpicon-colour_desc'] = 'Farbe der Navigationslinks.';
$string['fpiconnavbg'] = 'Schaltfläche "Startseite" Hintergrundfarbe';
$string['fpiconnavbg_desc'] = 'Hintergrundfarbe der Schaltfläche "Startseite"';
$string['fpiconnavhover'] = 'Hintergrund des Maus-Hovers';
$string['fpiconnavhover_desc'] = 'Hintergrundfarbe der Navigationszeile bei einem Maus-Hover';
...
$string['fpstartwrap'] = 'Navigationshintergrundfarbe';
$string['fpstartwrap_desc'] = 'Hintergrundfarbe der Navigationsleiste';
...
$string['headercolor'] = 'Headertext-Farbe';
$string['headercolor_desc'] = 'Diese Einstellung verändert die Farbe des Titels H1.';
$string['headerdefaultimage'] = 'TitelStandard-Kopfbild';
$string['headerdefaultimage_desc'] = 'Standardbild für den Kurstitel';
$string['headericon'] = 'Symbol der Titelzeile';
$string['headericon_desc'] = 'Diese Einstellung ändert das Symbol, das in der Titelzeile neben dem Titel erscheint. Es handelt sich dabei um Font-Awesome-Symbole.';
...
$string['headerscreen'] = 'Titelbereich-Hintergrundfarbe';
$string['headerscreen_desc'] = 'Die Farbe des Hintergrundes des Titelbereichs.';
$string['headingcolor'] = 'Titelfarbe';
$string['headingcolor_desc'] = 'Farbeinstellungen für H1-H6.';
$string['headingfont'] = 'Schriftart Überschriften';
$string['headingfont_desc'] = 'Wählen Sie eine Google-Schriftart für alle Überschriften.';
...
$string['linkcolor'] = 'Standard-Linkfarbe';
$string['linkcolor_desc'] = 'Standard-Linkfarbe.';
...
$string['navbarbkg'] = 'Navigationzeile-Hintergrundfarbe';
$string['navbarbkg_desc'] = 'Hintergrundfarbe der Navigationszeile';
$string['navbarcolorswitch'] = 'Navigationsleiste Farbwähler';
$string['navbarurl'] = 'Navigationszeile-Linkfarbe';
$string['navbarurl_desc'] = 'Farbe der Links in der Navigationszeile';
...
$string['pagefont'] = 'Schriftart Seite';
$string['pagefont_desc'] = 'Wählen sie eine Schriftart für den Seitentext.';
...
$string['sectionicon'] = 'Kursabschnittssymbol';
$string['sectionicon_desc'] = 'Diese Font-Awesome-Symbole erlauben es ihnen, das Symbol neben dem Abschnitt/der Woche zu ändern.';
...
$string['showbacktotop'] = 'Zeige den Button "Zurück nach oben"';
$string['showbacktotop_desc'] = 'Entferne diese Einstellung um den Button "Zurück nach oben" zu verstecken.';
