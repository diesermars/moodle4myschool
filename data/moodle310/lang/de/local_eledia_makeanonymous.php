...
/**
 * Strings for component 'local_eledia_makeanonymous', language 'de', version '3.10'.
 *
...
$string['eledia_makeanonymous_task'] = 'Task zur verspäteten Anonymisierung von gelöschten Nutzer/innen';
...
$string['makeanonymous_delay_time'] = 'Verzögerung (in Minuten)';
$string['makeanonymous_desc'] = '<h3>Anonymisierung gelöschter Nutzerkonten</h3>
Das Plugin \'makeanonymous\' von eLeDia sorgt dafür, dass gelöschte Nutzerkonten automatisch anonymisiert und die Inhalte aller Profilfelder überschrieben werden.

<h4>Profilfelder</h4>';
$string['makeanonymous_enable'] = 'Anonymisierung aktivieren';
$string['makeanonymous_enable_desc'] = 'Wenn diese Option deaktiviert ist, wird der Prozess nicht ausgeführt.';
