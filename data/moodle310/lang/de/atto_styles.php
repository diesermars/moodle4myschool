...
/**
 * Strings for component 'atto_styles', language 'de', version '3.10'.
 *
 * @package     atto_styles
 * @category    string
...
$string['config_desc'] = 'Konfiguration für die Gestaltungsvorlagen in Atto im JSON Format.<br/> Sie können ein ausgiebiges Beispiel in der README.md im Abschnitt <a href="https://github.com/moodleuulm/moodle-atto_styles/blob/master/README.md#usage--settings">"Usage & Settings"</a> finden.
<hr />
Beispiel:<br />
{$a->code_example}
<hr />
...
$string['jsondecodemessage'] = 'Der eingegebene JSON Code ist nicht valide.';
