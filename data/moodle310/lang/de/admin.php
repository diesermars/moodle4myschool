...
/**
 * Strings for component 'admin', language 'de', version '3.10'.
 *
 * @package     admin
 * @category    string
...
$string['cron_enabled_desc'] = 'Wenn diese Option deaktiviert wird, kann das System keine neuen Hintergrundprozesse starten. Diese Option ist nur zur vorübergehenden Verwendung vorgesehen, z.B. vor einem Neustart. Wenn Sie es für längere Zeit nicht verwenden, funktionieren wichtige Funktionen nicht mehr.';
...
$string['cronwarning'] = 'Das <a href="{$a->url}">admin/cron.php script</a> wurde in den letzten {$a->actual} nicht ausgeführt, sollte aber alle {$a->expected} laufen.';
$string['cronwarningcli'] = 'Das Script <code>admin/cli/cron.php</code> wurde in den letzten {$a->actual} nicht ausgeführt, sollte aber alle {$a->expected} laufen.';
$string['cronwarningnever'] = 'Das <code>admin/cli/cron.php</code> Script wurde noch nie ausgeführt, sollte aber alle {$a->expected} laufen.';
$string['cronwarningneverweb'] = 'Das <a href="{$a->url}">Skript admin/cron.php</a> wurde noch nie ausgeführt und sollte alle {$a->expected} ausgeführt werden.';
...
$string['rememberuserlicensepref_help'] = 'Diese Einstellung legt fest, dass die zuletzt von einer Person ausgewählte Lizenz beim nächsten Hochladen in der Dateiauswahl vorausgewählt ist. Andernfalls wird die standardmäßige Standortlizenz vorausgewählt.';
...
$string['userfeedbackencouragement'] = '<p>Moodle 3.9 enthält eine neue Funktion, mit der Nutzer/innen über eine externe Umfrage ein Feedback zur Moodle-Software abgeben können. Für diese Umfrage werden keine personenbezogenen Daten an die externe Website weitergeleitet.</p>
<p>Moodle HQ ist um eine offene und transparente Datenerhebung bemüht. Die Administrator/innen sollen diese Funktionalität kennen und voll unter ihrer Kontrolle haben. Das Feedback der Nutzer/innen unterstützt das Moodle HQ sehr, die Software zu verbessern. Um diese Funktion zu aktivieren, gehen Sie bitte zu <a href="{$a}">Feedback-Einstellungen</a>.</p>';
