...
/**
 * Strings for component 'publication', language 'de', version '3.10'.
 *
 * @package     publication
 * @category    string
...
für \'{$a->publication}\' auf {$a->apstatus}, zugestimmt am {$a->dayupdated} um {$a->timeupdated}, geändert.

Hier verfügbar:

    {$a->url}';
$string['emailstudentsmailhtml'] = '{$a->username} hat die Einverständniserkärung zu \'{$a->filename}\'
für <i>\'{$a->publication}\'</i> auf <b>{$a->apstatus}</b>, zugestimmt am {$a->dayupdated} um {$a->timeupdated}</i>, geändert.<br /><br />
