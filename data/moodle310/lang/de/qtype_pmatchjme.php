...
/**
 * Strings for component 'qtype_pmatchjme', language 'de', version '3.10'.
 *
...
$string['addingpmatchjme'] = '"Musterabgleich mit Java Molecular Editor" Frage hinzufügen';
...
$string['editingpmatchjme'] = '"Musterabgleich mit Java Molecular Editor"-Frage bearbeiten';
...
$string['pmatchjme'] = 'Musterabgleich mit Java Molecular Editor';
$string['pmatchjme_help'] = 'Als Antwort auf eine Frage (die auch ein Bild enthalten kann) verwendet der Befragte den JME-Editor, um eine Molekularstruktur zu beschreiben. Es kann mehrere mögliche richtige Antworten geben, jede mit einer anderen Bewertung.';
$string['pmatchjmesummary'] = 'Ermöglicht das Zeichnen eines Moleküls mit dem JME-Editor. Die Antwort wird durch Vergleich mit verschiedenen Modellantworten bewertet, die mit der Mustervergleichssyntax der OE beschrieben werden.';
