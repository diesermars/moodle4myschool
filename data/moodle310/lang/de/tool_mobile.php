...
/**
 * Strings for component 'tool_mobile', language 'de', version '3.10'.
 *
 * @package     tool_mobile
 * @category    string
...
$string['qrsiteadminsnotallowed'] = 'Aus Sicherheitsgründen ist eine Anmeldung über QR-Code für Website-Administratoren oder wenn Sie als anderer Benutzer angemeldet sind, nicht zulässig.';
...
$string['subscriptionsseemore'] = 'Hinweis: Die angezeigten Infos werden nicht in Echtzeit aktualisiert. Möglicherweise müssen Sie sich abmelden und erneut anmelden, um die Aktualisierungen anzuzeigen. Infos zum Aktualisieren Ihres App-Plans erhalten Sie im <a href="{$a}" target="_blank">Moodle Apps-Portal</a>.';
