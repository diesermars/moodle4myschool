...
/**
 * Strings for component 'treasurehunt', language 'de', version '3.10'.
 *
...
$string['activitytoend_help'] = 'Die ausgewählte Aktivität muss abgeschlossen sein, bevor der aktuelle Hinweis angezeigt wird. Damit Aktivitäten in der Liste angezeigt werden, muss die Abschlussverfolgung aktiviert sein, u.z. für den Kurs und die Aktivität selbst.';
...
$string['actnotavailableyet'] = 'Die Aktivität ist bisher noch nicht verfügbar.';
$string['add'] = 'Hinzufügen';
$string['addingroad'] = 'Weg wird hingefügt';
...
$string['addstage_tour'] = 'Jeder Weg muss zwei oder mehr Stationen haben. An jeder Station gibt es einen Hinweis, wo sich die nächste Station befindet.';
$string['aerialmap'] = 'Luftbild';
$string['aerialview'] = 'Luftbild';
$string['allowattemptsfromdate'] = 'Versuche ab';
$string['allowattemptsfromdate_help'] = 'Die Option legt den Zeitpunkt fest, ab dem die Spieler/innen spielen dürfen. Wenn diese Option deaktiviert ist, können die Spieler/innen sofort beginnen.';
...
$string['areyousure'] = 'Sind Sie wirklich sicher?';
...
<br>Erlauben Sie dafür "Standort verwenden", wenn Sie dazu aufgefordert werden.';
$string['availability'] = 'Verfügbarkeit';
$string['availableplayerstyles'] = 'Bildschirmstile verfügbar';
$string['back'] = 'Zurück';
...
<br>Mit einem Klick werden Ihnen <b>Herausforderungen</b> oder wertvolle <b>Hinweise</b> angezeigt.';
$string['browsemode'] = 'Durchsuchen';
...
$string['cleartreasurehunt_done'] = 'Die Schatzsuche wurde zurückgesetzt. Alle Aktivitäten der Spieler/innen wurden gelöscht.';
$string['cleartreasurehuntconfirm'] = 'Möchten Sie wirklich fortfahren? Alle aufgezeichneten Aktivitäten werden gelöscht. Diese Aktion ist nur erforderlich, wenn Sie die Anzahl der Wege oder Stationen ändern möchten, aber jemand das Spiel begonnen hat und alle Änderungen blockiert.';
$string['clue'] = 'Hinweis';
$string['completionfinish'] = 'Notwendig, um den Weg zu beenden';
$string['completionfinish_help'] = 'Abgeschlossen, wenn die Person alle Stationen eines Weges passiert hat.';
$string['configintro'] = 'Alle hier festgelegten Werte werden beim Anlegen einer neuen Schatzsuche als Voreinstellung verwendet.';
$string['configmaximumgrade'] = 'Höchste Bewertungsstufe in diesem Modul';
...
$string['customlayername_help'] = 'Wenn Sie eine nutzerdefinierte Ebene verwenden, wird ein Titel benötigt, um ihn in den Karten und den Spieler/innen anzuzeigen. Wenn der Titel leer ist, wird die nutzerdefinierte Ebene vollständig deaktiviert.';
$string['customlayertype'] = 'Typ der Ebene';
$string['customlayertype_help'] = 'Die Ebene kann die einzige im Hintergrund sichtbare sein oder sie kann über die Standardkarten gelegt werden.';
$string['customlayerwms'] = 'WMS Dienst';
$string['customlayerwms_help'] = 'Verwenden Sie eine Kartenebene eines OGC WMS-Dienstes.

Als Beispiel kann \'EUNIS Forest Ecosystems WMS\' folgendermaßen konfiguriert werden:
...
$string['custommapimagefile_help'] = 'Laden Sie ein Bild mit ausreichender Auflösung hoch und tragen Sie die Projektionskoordinaten für die Fläche in die folgenden 4 Felder ein.';
$string['custommapmaxlat'] = 'Nördlicher Breitengrad';
$string['custommapmaxlat_help'] = 'Nördlicher Breitengrad
<br>Hier wird der Wert für die nördlichste Stelle des Bildes erwartet. Nutzen Sie "." als Dezimaltrennzeichen. Der Wert muss kleiner als 85 Grad und größer als der südliche Breitengrad sein.';
$string['custommapmaxlon'] = 'Östlicher Längengrad';
$string['custommapmaxlon_help'] = 'Östlicher Längengrad
<br>Hier wird der Wert für die östlichste Stelle des Bildes erwartet. Nutzen Sie "." als Dezimaltrennzeichen. Der Wert muss kleiner als 180 Grad und größer als der westliche Längengrad sein.';
$string['custommapminlat'] = 'Südlicher Breitengrad';
$string['custommapminlat_help'] = 'Südlicher Breitengrad
<br>Hier wird der Wert für die südlichste Stelle des Bildes erwartet. Nutzen Sie "." als Dezimaltrennzeichen. Der Wert muss größer als -85 Grad und kleiner als der nördliche Breitengrad sein.';
$string['custommapminlon'] = 'Westlicher Längengrad';
$string['custommapminlon_help'] = 'Westlicher Längengrad
<br>Hier wird die westlichste Stelle des Bildes erwartet. Nutzen Sie "." als Dezimaltrennzeichen. Der Wert muss größer als -180 Grad und kleiner als der östliche Längengrad sein.';
...
Als Beispiel kann \'EUNIS Forest Ecosystems WMS\' folgendermaßen konfiguriert werden: WMS: <code style="overflow-wrap: break-word;word-wrap: break-word;">http://bio.discomap.eea.europa.eu/arcgis/services/Ecosystem/Ecosystems/MapServer/WMSServer</code> PARAMS: <code>LAYERS=4</code>';
$string['cutoffdate'] = 'Spielende';
$string['cutoffdate_help'] = 'Diese Option legt fest, dass die Schatzsuche nach diesem Termin keine Versuche mehr erlaubt.';
$string['cutoffdatefromdatevalidation'] = 'Das Spielende muss nach dem Spielanfang liegen.';
$string['defaultplayerstyle'] = 'Standardmäßiger Bildschirmstil';
$string['discoveredlocation'] = 'Richtiger Standort';
$string['donetutorial'] = 'Ende';
$string['drawmode'] = 'Zeichnen';
$string['editactivity_help'] = 'Eine Schritt-für-Schritt-Anleitung zum Erstellen von Schatzsuchen finden Sie  <a href="http://juacas.github.io/moodle-mod_treasurehunt/create_activity.html">auf dieser Website</a>.';
$string['editend_tour'] = 'Viel Spaß beim Erstellen spannender Schatzsuchen für Ihre Teilnehmer/innen!';
...
$string['edition'] = 'Bearbeitungsfenster';
$string['edition_help'] = 'Um die Geometrieerstellung und die Schaltflächen im Bearbeitungsfenster zu aktivieren, muss die Station ausgewählt werden, die Sie bearbeiten möchten.';
...
$string['errcorrectanswers'] = 'Sie müssen die richtige Antwort auswählen.';
...
$string['errsendinganswer'] = 'Der Weg wurde aktualisiert, während Sie die Antwort gesendet haben. Versuchen Sie es noch einmal.';
$string['errsendinglocation'] = 'Der Weg wurde aktualisiert, während Sie den Standort gesendet haben. Versuchen Sie es noch einmal.';
...
$string['gameupdatetime_help'] = 'Zeitintervall (in Sekunden) zwischen zwei Aktualisierungen der Spielansicht. Je größer das Intervall ist, desto seltener wird die Spielansicht aktualisiert und desto später werden mögliche Veränderungen festgestellt. Das Intervall muss größer als 0 Sekunden sein.';
$string['geolocation_needed'] = 'Um dieses Spiel spielen zu können, sind Ihre Standortdaten (Geolocation) erforderlich.<p>Erlauben Sie in den Browsereinstellungen die Standortdaten für diese Website. Laden Sie anschließend diese Seite neu und antworten Sie mit "Ja", falls der Browser fragt, ob Sie Ihren Standort teilen möchten.</p>
<p>Um die Standortdaten Ihres Endgeräts während der Schatzsuche verwenden zu können, muss die Website über HTTPS vom Server kommen. Andernfalls ist nur der Modus "Spielen ohne Bewegung" möglich und die Spieler/innen müssen die Stationen manuell auf der Karte zeigen. Wenden Sie sich an Ihren Administrator, wenn Sie dieses Problem nicht lösen können.</p>';
$string['geolocation_needed_title'] = 'Diese Anwendung benötigt Standortdaten.';
$string['grade_explaination_fromabsolutetime'] = '{$a->rawscore}-{$a->penalization}%: Sie haben die Schatzsuche mit {$a->yourtime} beendet. Die Bestzeit liegt bei {$a->besttime}. Sie erhalten einen Zeitabzug von {$a->penalization}% wegen {$a->nolocationsfailed} falscher Wegpunkte und wegen {$a->noanswersfailed} falscher Antworten.';
...
<br/>Dies ermöglicht es, die Schatzsuche zu „parallelisieren“ und eine größere Fläche abzudecken. Die Teilnehmer/innen sehen die gleichen Informationen, aber teamorientiert.';
...
$string['lastsuccessfulstage_tour'] = 'In diesem Panel können Sie Ihre letzte erfolgreiche Station herausfinden. Dies ist entweder Ihre eigene Station oder die Ihres Teams.';
...
$string['locktimeediting'] = 'Bearbeitungssperrfrist';
...
$string['map_tour'] = 'Auf dieser Karte können Sie alle Elemente eines geobasierten Spiels verwalten.';
$string['mapplay_tour'] = 'Die <b>Karte</b> zeigt Ihnen alle eigenen Versuche! <br>Erfolgreich: <img src="pix/success_mark.png" width="28" /> <br>Fehlgeschlagen: <img src="pix/fail_mark.png" width="28" />';
$string['mapplaymobile_tour'] = 'Die <b>Karte</b> zeigt Ihnen alle eigenen Versuche! <br>Erfolgreich: <img src="{$a->successurl}" width="28" /> <br>Fehlgeschlagen: <img src="{$a->failureurl}" width="28" />';
$string['mapview'] = 'Kartenanzeige';
$string['modify'] = 'Ändern';
$string['modulename'] = 'Schatzsuche';
$string['modulename_help'] = '<p>Die Aktivität "Schatzsuche (TreasureHunt)" ermöglicht eine Stationensuche mit Geolocation und QR-Codes.</p>
<p>Sie können für Ihre Teilnehmer/innen ernsthafte Spiele organisieren, z.B. eine Schatzsuche draußen im Freien, drinnen im Gebäude oder auf virtuellen Karten.
Das Modul implementiert ein browserbasierte Spiel in Moodle. Es muss keine native App installiert werden. Zum Codieren der Spielphasen gibt es einen geografischen Editor.</p>
...
<p><b><a href="https://juacas.github.io/moodle-mod_treasurehunt/index.html">Weitere Informationen und eine schrittweise Anleitung</a></b></p>';
...
$string['nomarks'] = 'Markieren Sie zuerst den gewünschten Punkt auf der Karte. Platzieren Sie den <img src="pix/my_location.png" width="28"/>';
...
$string['playerstyle'] = 'Bildschirmstil';
...
$string['remove_tour'] = 'Sie können Teile der Positionsgeometrien löschen. Wählen Sie einfach ein Polygon aus und drücken Sie diese Taste.';
$string['removealltreasurehuntattempts'] = 'Alle Versuche der Schatzsuche löschen';
$string['removedactivitytoend'] = 'Die abzuschließende Aktivität wurde entfernt.';
$string['removedquestion'] = 'Die Frage wurde entfernt.';
$string['removeroadwarning'] = 'Wenn Sie den Weg entfernen, werden gleichzeitig auch alle zugehörigen Stationen entfernt. Sie können dies nicht rückgängig machen.';
$string['removewarning'] = 'Wenn Sie dies entfernen, können Sie es nicht rückgängig machen.';
$string['restrictionsdiscoverstage'] = 'Einschränkungen, um die Station zu entdecken';
$string['reviewofplay'] = 'Rückblick auf das Spiel';
$string['road'] = 'Weg';
$string['roadended'] = 'Der Weg ist abgeschlossen. Herzlichen Glückwünsch! Sie haben die Schatzsuche beendet. Sie können den Verlauf in der Karte überprüfen.';
$string['roadmap'] = 'Weg';
...
$string['searchlocation_tour'] = 'Mit diesem Suchbereich finden Sie schnell Ihren Weg.';
$string['send'] = 'Senden';
$string['sendlocationcontent'] = 'Diese Aktion kann nicht zurückgenommen werden.';
$string['sendlocationtitle'] = 'Möchten Sie wirklich diesen Standort senden?';
...
$string['stageclue_help'] = 'Im Hinweis sollten Sie ganz genau beschreiben, wie der nächste Ort zu finden ist.
Falls dies die letzte Station ist, müssen Sie mitteilen, dass die Schatzsuche hier beendet ist.';
...
$string['start'] = 'Start';
$string['startfromhere'] = 'Sie können nur von hieraus starten.';
$string['state'] = 'Status';
...
$string['timeexceeded'] = 'Sie haben das Zeitlimit für die Aktivität überschritten. Dieser Bildschirm dient nur als Rückblick aus das Spiel.';
...
$string['treasurehuntislocked'] = '{$a} bearbeitet gerade diese Schatzsuche. Versuchen Sie es in wenigen Minuten noch einmal.';
$string['treasurehuntname'] = 'Name der Schatzsuche';
$string['treasurehuntnotavailable'] = 'Die Schatzsuche ist erst verfügbar ab {$a}.';
$string['treasurehuntopenedon'] = 'Diese Schatzsuche hat begonnen am {$a}.';
...
$string['useractivityovercome'] = '<b>Moodle Aktivität für "Station {$a->position}" erfolgreich abgeschlossen</b> {$a->date}';
$string['userattempthistory'] = 'Versuchsverlauf von {$a}';
$string['userinvalidroad'] = '{$a} hat einen falschen Weg zugeordnet.';
$string['userlocationfailed'] = '<b>Fehlerhafte Ortssuche "Station {$a->position}"</b> {$a->date}';
$string['userlocationovercome'] = '<b>Erfolgreiche Ortssuche "Station {$a->position}"</b> {$a->date}';
$string['usermultipleroads'] = '{$a} hat mehr als einen Weg zugeordnet.';
$string['usermultiplesameroad'] = '{$a} gehört zu mehr als einem Team, zugeordnet zum gleichen Weg';
...
$string['usersprogress_help'] = 'Zeigt den Fortschritt aller Spieler/innen oder jedes Teams als Farben an: <br/>
Die Farbe <b>grün</b> zeigt an, dass die Station ohne Fehler bestanden wurde.<br/>
Die Farbe <b>gelb</b> zeigt an, dass die Station mit Fehlern bestanden wurde.<br/>
Die Farbe <b>rot</b> zeigt an, dass die Station nicht bestanden wurde und Fehler aufgetreten sind.<br/>
Die Farbe <b>grau</b> zeigt an, dass die Station nicht bestanden wurde und keine Fehler gemacht wurden.';
...
$string['warnqrscanner'] = '<table><tr><td>Diese Schatzsuche enthält {$a} Stationen mit QR-Codes.
Stellen Sie sicher, dass Ihr Endgerät diese Codes über den Webbrowser scannen kann. Eine Ansicht Ihrer Kamera sollte unten angezeigt werden. Versuchen Sie, einen QR-Code wie diesen zu lesen.</td><td><a href="pix/qr.png"><img src="pix/qr.png" align="top" width="100"></a></td> </tr></table>';
$string['warnqrscannererror'] = 'Diese Schatzsuche enthält {$a} Stationen mit QR-Codes.
Scheinbar kann Ihr Endgerät seine Kamera mit dieser Anwendung nicht verwenden. Geben Sie bitte die Erlaubnis, auf die Kamera zuzugreifen.
...
Es sieht so aus, dass Sie mit diesem Endgerät den QR-Test bestanden haben.';
$string['warnunsecuregeolocation'] = 'Geolocation funktioniert möglicherweise nicht auf Ihrem Server. Dies ist eine <b>SEVERE misconfiguration</b>, die durch Ihre Serverkonfiguration verursacht wird.
<br>Geolocation ist für nicht sichere Server verboten, die HTTP anstelle von HTTPS verwenden. Um GPS zur Lokalisierung Ihrer Teilnehmer/innen bei der Schatzsuche nutzen zu können, muss der Server auf HTTPS umgestellt werden. Andernfalls ist nur der Modus "Spielen ohne Bewegung" verfügbar und die Spieler müssen jede Station manuell auf der Karte zeigen. Wenden Sie sich an Ihren Administrator.
...
$string['warnusersgroup'] = 'Folgenden Nutzer/innen gehören zu keinem Team und können deswegen das Spiel nicht spielen: {$a}';
...
$string['welcome_play_tour'] = '<span style="font-size: 1.5rem; font-weight: bold">Willkommen bei der Schatzsuche!</span><br>Diese Landkarte und die Hinweise werden Sie zum Ziel führen.';
